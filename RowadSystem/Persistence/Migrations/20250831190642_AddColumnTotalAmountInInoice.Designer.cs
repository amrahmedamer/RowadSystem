...
namespace RowadSystem.Migrations
{
    ...
    [Migration("20250831190642_AddColumnTotalAmountInInoice")]
    partial class AddColumnTotalAmountInInoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RowadSystem.Entity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 31, 19, 6, 40, 882, DateTimeKind.Utc).AddTicks(8201),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDrrdCIy8PNLDqCDmpiIEyiIrvK68eDUwIHDNAoaVdPvSECLNQuNlYYVoHSb+iNFsg==",
            ...
            modelBuilder.Entity("RowadSystem.Entity.Order", b =>
                {
                    ...
                    b.HasOne("RowadSystem.API.Entity.Street", "Street")
                        .WithMany()
