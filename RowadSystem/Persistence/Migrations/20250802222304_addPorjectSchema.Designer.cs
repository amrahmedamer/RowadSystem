...
namespace RowadSystem.Migrations
{
    ...
    [Migration("20250802222304_addPorjectSchema")]
    partial class addPorjectSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RowadSystem.Entity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 2, 22, 23, 3, 616, DateTimeKind.Utc).AddTicks(6601),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEB6QM/9h25TODKeAOvvQTlvmEhalXAGWYgT8kpBHKOxtbY073eizyj077YiUy5jngA==",
            ...
            modelBuilder.Entity("RowadSystem.Entity.Payment", b =>
                {
                    ...
                    b.HasOne("RowadSystem.Entity.Invoice", "Invoice")
                        .WithOne("Payment")
                        .HasForeignKey("RowadSystem.Entity.Payment", "InvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
