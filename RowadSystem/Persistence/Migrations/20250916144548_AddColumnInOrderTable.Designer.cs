...
namespace RowadSystem.Migrations
{
    ...
    [Migration("20250916144548_AddColumnInOrderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.CashierHandover", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("AmountInDrawer")
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.ExpenseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.Governorate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.Street", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RowadSystem.Entity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 16, 14, 45, 47, 276, DateTimeKind.Utc).AddTicks(4954),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECKorBCGTy4svXO4kL9cOtmBHIh1V3p3fI0TUo0Ipido1Ep7ZeADP4imJmVfrJZCSA==",
            ...
            modelBuilder.Entity("RowadSystem.Entity.PurchaseReturnInvoice", b =>
                {
                    b.HasBaseType("RowadSystem.Entity.Invoice");
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.City", b =>
                {
                    b.HasOne("RowadSystem.API.Entity.Governorate", "Governorate")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.Expense", b =>
                {
                    b.HasOne("RowadSystem.API.Entity.ExpenseCategory", "ExpenseCategory")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("RowadSystem.API.Entity.Street", b =>
                {
                    b.HasOne("RowadSystem.API.Entity.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("RowadSystem.Entity.PurchaseReturnInvoice", b =>
                {
                    b.HasOne("RowadSystem.Entity.Invoice", null)
                        .WithOne()
                        .HasForeignKey("RowadSystem.Entity.PurchaseReturnInvoice", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RowadSystem.Entity.PurchaseReturnDetail", b =>
                {
                    ...
                    b.HasOne("RowadSystem.Entity.PurchaseReturnInvoice", "PurchaseReturn")
