...
{
    /// <inheritdoc />
    public partial class addPorjectSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_contactNumbers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_contactNumbers_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseReturns_Invoices_Id",
                        column: x => x.Id,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesInvoices_Coupons_CouponId",
                        column: x => x.CouponId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseReturnDetails_InvoiceDetails_Id",
                        column: x => x.Id,
                        principalTable: "InvoiceDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesReturns_Invoices_Id",
                        column: x => x.Id,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesReturnDetails_InvoiceDetails_Id",
                        column: x => x.Id,
                        principalTable: "InvoiceDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CreatedAt", "CreatedBy", "IsDeleted", "PasswordHash", "UpdatedAt", "UpdatedBy" },
                values: new object[] { new DateTime(2025, 8, 2, 22, 23, 3, 616, DateTimeKind.Utc).AddTicks(6601), null, false, "AQAAAAIAAYagAAAAEB6QM/9h25TODKeAOvvQTlvmEhalXAGWYgT8kpBHKOxtbY073eizyj077YiUy5jngA==", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_contactNumbers_SupplierId",
                table: "contactNumbers",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoices_CouponId",
                table: "SalesInvoices",
                column: "CouponId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { true, "AQAAAAIAAYagAAAAEI9kcHuXdAqIB9dHvOCpNCcJHhFZYK/ah8epXWpcdCDodsIKbANybuQ5D7bhL3YYkw==" });
